...
from .models import (
    ...
    Review, ContactMessage, Notification
)
...
class NotificationAdmin(admin.ModelAdmin):
    list_display = ("channel", "phone", "status", "provider_id", "created_at")
    list_filter = ("channel", "status")
    search_fields = ("phone", "message", "provider_id")
    readonly_fields = ("user", "order", "channel", "phone", "message", "status", "provider_id", "created_at")
